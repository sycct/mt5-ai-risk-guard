    ...
    async def call_tool(self, name, arguments):
        ...
        return {
            "get_trading_account_info": {"balance": 50000, "equity": 49000, "credit": 100,
                                         "profit": -1100, "commission": -2, "marginLevel": 3000},
            "get_trading_open_positions": {
                "positions": [{"ticket": 1, "symbol": "XAUUSD", "type": 0, "volumeCurrent": 0.2, "profit": -5}],
                "orders": [{"ticket": 2, "symbol": "XAUUSD", "type": "buy_limit", "volume": 0.1}],
            },
            "get_marketwatch_symbols": {"symbols": [{"name": "XAUUSD", "bidPrice": 2500, "askPrice": 2500.2, "point": 0.01}]},
...
async def test_combined_positions_and_orders_tool_is_called_once_and_split():
    ...
    assert snapshot.account.margin_level == 3000
